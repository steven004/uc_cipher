...
static void test_uces_verbose(void);
...
static void test_ecb_verbose(void)
{
    ...
    // print the resulting decode(plain_text) as 4 x 16 byte strings
    printf("decodetext:\n");
...
static void test_uces_verbose(void)
{
    ...
    UCES_encrypt_buffer(key, iv, plain_text, 64);
    for (i = 0; i < 4; ++i)
    {
      phex(plain_text + (i * 16));
    }
    ...
    UCES_decrypt_buffer(key, iv, plain_text, 64);
    for (i = 0; i < 4; ++i)
    {
      phex(plain_text + (i * 16));
    }
